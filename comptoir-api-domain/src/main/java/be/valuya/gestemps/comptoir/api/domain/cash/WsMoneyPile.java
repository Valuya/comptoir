package be.valuya.gestemps.comptoir.api.domain.cash;

import be.valuya.gestemps.comptoir.api.domain.accounting.WsAccountRef;
import be.valuya.gestemps.comptoir.api.domain.accounting.WsBalanceRef;
