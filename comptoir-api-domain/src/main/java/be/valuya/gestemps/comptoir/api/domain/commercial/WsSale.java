...
import be.valuya.gestemps.comptoir.api.domain.accounting.WsAccountingTransactionRef;
import be.valuya.gestemps.comptoir.api.domain.thirdparty.WsCustomerRef;
